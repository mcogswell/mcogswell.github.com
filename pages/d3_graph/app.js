...
var nodes = [
  ...
  links = [
    ...
    {source: nodes[3], target: nodes[6], left: false, right: false },
    {source: nodes[4], target: nodes[6], left: false, right: false },
    {source: nodes[4], target: nodes[7], left: false, right: false },
    {source: nodes[5], target: nodes[7], left: false, right: false }
  ];
...
function restart() {
  ...
  g.append('svg:text')
      ...
      .attr('class', 'id')
      .text(function(d) { 
          return 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'.charAt(d.id);
          //return d.id;
      });
